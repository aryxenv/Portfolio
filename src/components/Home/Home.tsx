        ...
        <section className="component home" id='home'>
            <div className='home-container' ref={ref}>
                ...
                transition={{ duration: 1 }}>
                    <div className='introduction-title'>
                        <div className='introduction-name'>
                            <h1>Hi! I'm <span className='gradient-animation'>Aryan Shah</span></h1>
                        </div>
                    ...
                    <div className='introduction-text'>
                        <p>
                            <span className='gradient-animation'>Data Science, Protection, and Security student</span> at
                            Thomas More University of Applied Sciences. Based in
                            <span className='gradient-animation'> Antwerp, Belgium</span> with a 
                            strong interest in Web Development/Design & Data Analytics. Developing skills in web development,
                            data science, data analytics, and database management
                            using React, TypeScript, JavaScript, Python, C#, PowerBI, SQL, etc. 
                    ...
                    <div className='introduction-stack-container'>
                            ...
                            <div className='introduction-stack introduction-top'>
                                <div className='introduction-stack-list'>
                                    <div className='marquee-wrapper'>
                                        ...
                                        {[...Array(4)].flatMap(() => techStackDataSliderTop).map((key, index) => (
                                            <TechStackSliderCard
                                                keyIndex={index}
                                                imageUrl={key.src}
                                                text={key.name}
                            ...
                            <div className='introduction-stack introduction-bottom'>
                                <div className='introduction-stack-list'>
                                    <div className='marquee-wrapper-reverse'>
                                        {/* added 4 dupes because 2 dupes isnt enough to cover the whole width on higher width viewports */}
                                        {[...Array(4)].flatMap(() => techStackDataSliderBottom).map((key, index) => (
                                            <TechStackSliderCard
                                                keyIndex={index}
                                                imageUrl={key.src}
                                                text={key.name}
                        ...
                        <div className='viewMoreVertical viewMoreVertical-smaller' onClick={() => window.location.href = '#contact'}>
                            <div className='opacityLayer opacityLayer-smaller'>
                                <div className='viewMore-title'>
                                    <span className='rotate90deg rotate90deg-smaller'>Contact me!</span>
                                </div>
                ...
                <div className='recents'>
                    <motion.div className='recentAndProject1'
                    ...
                    {isSmallScreen ? (
                        <>
                            <motion.div className='project2AndViewProjects'
                            initial={{ opacity: 0, transform: "translateX(-50px)" }}
                            animate={inView ? { opacity: 1, transform: "translateX(0px)" } : { opacity: 0, transform: "translateX(-50px)" }}
                            transition={{ duration: 1 }}>
                                <ProjectCard
                                ...
                                <div className='viewMoreVertical' onClick={() => window.location.href = "#projects"}>
                        ...
                        <>
                            ...
                            <motion.div className='viewMoreVertical' 
