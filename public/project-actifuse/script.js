...
mailCard.addEventListener("click", function () {
  window.open("mailto:aryan@aryxenv.dev", "_blank");
});
...
downloadBtn.addEventListener("click", function () {
  window.open(
    "https://github.com/legelff/ProjectActifuse/releases/tag/Pre-release",
    "_blank",
  );
});
